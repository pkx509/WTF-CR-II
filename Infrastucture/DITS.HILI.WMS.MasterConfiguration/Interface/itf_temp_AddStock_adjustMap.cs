...
{
    public class itf_temp_AddStock_adjustMap : EntityTypeConfiguration<itf_temp_AddStock_adjust>
    {
        public itf_temp_AddStock_adjustMap()
        {
            // Primary Key
            ...
            ToTable("itf_temp_AddStock_adjust");
