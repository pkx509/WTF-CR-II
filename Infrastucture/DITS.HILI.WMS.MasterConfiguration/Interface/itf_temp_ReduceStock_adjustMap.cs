...
{
    public class itf_temp_ReduceStock_adjustMap : EntityTypeConfiguration<itf_temp_ReduceStock_adjust>
    {
        public itf_temp_ReduceStock_adjustMap()
        {
            // Primary Key
            ...
            ToTable("itf_temp_ReduceStock_adjust");
