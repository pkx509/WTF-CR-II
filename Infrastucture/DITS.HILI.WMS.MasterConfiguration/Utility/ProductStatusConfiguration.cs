...
{
    public class ProductStatusConfiguration : EntityTypeConfiguration<ProductStatus>
    {
        ...
        public ProductStatusConfiguration(string schema)
        {
            ToTable(schema + ".sys_product_status");

            HasKey(x => x.ProductStatusID);
            Property(x => x.ProductStatusID).IsRequired().HasColumnName("ID").HasColumnType("uniqueidentifier")
