...
{
    public class AdjustPrefixConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AdjustPrefix>
    {
        public AdjustPrefixConfiguration()
            : this("dbo")
        {
        }

        public AdjustPrefixConfiguration(string schema)
        {
            ToTable(schema + ".adj_adjust_prefix");
