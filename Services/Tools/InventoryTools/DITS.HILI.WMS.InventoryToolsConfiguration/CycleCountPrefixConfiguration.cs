...
{
    public class CycleCountPrefixConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<CycleCountPrefix>
    {
        public CycleCountPrefixConfiguration()
            : this("dbo")
        {
        }

        public CycleCountPrefixConfiguration(string schema)
        {
            ToTable(schema + ".cc_cyclecount_prefix");
