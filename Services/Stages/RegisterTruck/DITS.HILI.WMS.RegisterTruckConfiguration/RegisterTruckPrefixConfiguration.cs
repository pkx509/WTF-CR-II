...
{
    public class ReceivePrefixConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RegisterTruckPrefix>
    {
        public ReceivePrefixConfiguration()
            : this("dbo")
        {
        }

        public ReceivePrefixConfiguration(string schema)
        {
            ToTable(schema + ".reg_truck_prefix");
