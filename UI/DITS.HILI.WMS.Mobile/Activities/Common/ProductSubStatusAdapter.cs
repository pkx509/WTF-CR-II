...
{
    public class ProductSubStatusAdapter : BaseAdapter<ProductSubStatus>
    {

        private List<ProductSubStatus> works;
        private LayoutInflater context;

        public ProductSubStatusAdapter(Activity _context, List<ProductSubStatus> _works)
            : base()
        {
        ...
        public override ProductSubStatus this[int position]
        {
            get
            {
