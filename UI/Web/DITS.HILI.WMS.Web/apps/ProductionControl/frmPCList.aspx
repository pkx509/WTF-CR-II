<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPCList.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.ProductionControl.frmPCList" %>
        ...
        <ext:Viewport runat="server" Layout="BorderLayout">
            <Items>
                <ext:FormPanel runat="server"
                        ...
                        <ext:Toolbar runat="server">
                            <Items>
                                ...
                                <ext:Button runat="server" ID="btnSearch" Icon="Magnifier" Text='<%$ Resource : SEARCH %>'>
                                    <Listeners>
                                        <Click Handler="#{PagingToolbar1}.moveFirst(); #{PagingToolbar2}.moveFirst();" Buffer="500" />
                                    </Listeners>
                                </ext:Button>
                            </Items>
                        </ext:Toolbar>
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="AnchorLayout" ColumnWidth="0.5" Padding="3">
                            <Items>
                                <ext:FieldSet runat="server" Title="<% $Resource : WAITFORPACK %>" Padding="3">
                                    <Items>
                                        <ext:GridPanel ID="grdPacking" runat="server" Height="450">
                                            <Store>
                                                <ext:Store ID="StorePacking" runat="server" PageSize="20" RemoteSort="false" AutoLoad="false">
                                                    <Proxy>
                                                        <ext:PageProxy DirectFn="App.direct.BindPackingData" />
                                                    </Proxy>
                                                    <Model>
                                            ...
                                            <ColumnModel runat="server">
                                                <Columns>
                                                    <ext:CommandColumn runat="server" ID="cmdPackingTag" Sortable="false" Align="Center" Width="25">
                                                        <Commands>
                                                            <ext:GridCommand Icon="TagBlue" CommandName="Edit" />
                                                        </Commands>
                                                        <DirectEvents>
                                                            <Command OnEvent="CommandPackingClick">
                                                                <ExtraParams>
                                                    ...
                                                    <ext:Column runat="server" DataIndex="ProductName" Text="<% $Resource : PRODUCT_NAME %>" Width="150" />
                                            ...
                                            <DirectEvents>
                                                <CellDblClick OnEvent="grdPacking_CellDblClick">
                                                    <ExtraParams>
                                                        <ext:Parameter Name="controlID" Value="record.data.ControlID" Mode="Raw" />
                                                    </ExtraParams>
                                                </CellDblClick>
                        ...
                        <ext:Container runat="server" Layout="AnchorLayout" ColumnWidth="0.5" Padding="3">
                            <Items>
                                <ext:FieldSet runat="server" Title="<% $Resource : PACKGOODS %>" Padding="3">
                                    <Items>
                                        <ext:GridPanel ID="grdPacked" runat="server" Height="450">
                                            <Store>
