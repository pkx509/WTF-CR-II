<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPickingList.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.outbound.picking.frmPickingList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport runat="server" Layout="BorderLayout">
            <Items>
                <ext:GridPanel ID="grdDataList" runat="server" Region="Center" Frame="true" Title="Picking List">
                    <TopBar>
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        ...
                        <Columns>
                            ...
                            <ext:Column ID="colPickingNo" runat="server" DataIndex="PickingNo" Text="Picking No."
                            ...
                            <ext:Column ID="colRoute" runat="server" DataIndex="Route" Text="Route"
                                Align="left" Flex="1" />
                            <ext:Column ID="colDock" runat="server" DataIndex="Dock" Text="Dock"
                                Align="left" Flex="1" />
                            <ext:DateColumn ID="colPickingDate" runat="server" DataIndex="PickingDate"
