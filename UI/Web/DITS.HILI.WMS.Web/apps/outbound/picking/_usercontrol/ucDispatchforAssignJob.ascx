<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucDispatchforAssignJob.ascx.cs" Inherits="DITS.HILI.WMS.Web.apps.outbound.picking._usercontrol.ucDispatchforAssignJob" %>

<ext:Window runat="server"
    ID="winDispatchSelect"
    Width="850"
    Height="500"
    Layout="FitLayout"
    Hidden="true"
    Modal="true"
    Title="<% $Resource : DISPATCHSELECT %>">
