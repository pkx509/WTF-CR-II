<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmShippingToAddEdit.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.truckqueue.frmShippingToAddEdit" %>
<!DOCTYPE html>
               ...
               <ext:FormPanel runat="server" ID="FormPanelDetail" AutoScroll="false" BodyPadding="3" Region="Center" Frame="true"  Layout="AutoLayout">
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="AnchorLayout" Flex="1" DefaultAnchor="100%">
                            ...
                            <Items>
                                <ext:FieldContainer runat="server" FieldLabel='<%$ Resource : QUEUESHIPNAME %>' Layout="HBoxLayout" LabelWidth="150" LabelAlign="Right">
                                    <Items> 
                                        <ext:TextField runat="server" ID="txtName" AllowBlank="false" Width="250" AutoFocus="true"></ext:TextField>
                                    </Items>
                                </ext:FieldContainer> 
                                 <ext:FieldContainer runat="server" FieldLabel='<%$ Resource : QUEUESHIPSNAME %>' Layout="HBoxLayout" LabelWidth="150" LabelAlign="Right">
                                    <Items>
                                        <ext:TextField runat="server" ID="txtShortName" AllowBlank="false" Width="250" AutoFocus="true"></ext:TextField>
                                    </Items>
                                </ext:FieldContainer> 
                                   <ext:FieldContainer runat="server" FieldLabel='<%$ Resource : QUEUESHIPADDR %>' Layout="HBoxLayout" LabelWidth="150" LabelAlign="Right">
                                    <Items>
                                        <ext:TextField runat="server" ID="txtAddress" AllowBlank="true" Width="250" AutoFocus="true"></ext:TextField>
                                    </Items>
                                </ext:FieldContainer> 
