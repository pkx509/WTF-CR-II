<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDockAddEdit.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.truckqueue.frmDockAddEdit" %>
<!DOCTYPE html>
                        ...
                        <ext:Container runat="server" Layout="AnchorLayout" Flex="1" DefaultAnchor="100%">
                            ...
                            <Items>
                                <ext:FieldContainer runat="server" FieldLabel='<%$ Resource : QUEUEDOCK %>' Layout="HBoxLayout" LabelWidth="150" LabelAlign="Right">
                                 ...
                                 <ext:FieldContainer runat="server" FieldLabel='<%$ Resource : QUEUEDESC %>' Layout="HBoxLayout" LabelWidth="150" LabelAlign="Right">
                                    <Items>
