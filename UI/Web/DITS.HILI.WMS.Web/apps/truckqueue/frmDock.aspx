<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDock.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.truckqueue.frmDock" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <ext:FieldContainer runat="server" FieldLabel="<%$ Resource : QUEUEDOCK %>" Layout="HBoxLayout" LabelAlign="Right" LabelWidth="50">
                                    <Items>
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server">
                                    <Fields> 
                                        ...
                                        <ext:ModelField Name="QueueDockDesc" /> 
                                        <ext:ModelField Name="IsActive" /> 
                                    </Fields>
                                </ext:Model>
                            </Model> 
                              <Sorters>
                                <ext:DataSorter Property="QueueDockName" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store> 
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="30">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.QueueDockID" Mode="Raw" /> 
                            ...
                            <ext:Column ID="colQueueDockName" Width="150" DataIndex="QueueDockName" runat="server" Text="<%$ Resource : QUEUEDOCK %>" Align="Center"  />
                            <ext:Column ID="colQueueDockDesc" Width="150" DataIndex="QueueDockDesc" runat="server" Text="<%$ Resource : QUEUEDESC %>" Align="Left" />
