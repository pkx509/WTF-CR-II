<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmQueueContactList.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.truckqueue.frmQueueContactList" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    <TopBar>
                        <ext:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <ext:FieldContainer runat="server" FieldLabel="<%$ Resource : QUEUECONTACTNAME %>" Layout="HBoxLayout" LabelAlign="Right" LabelWidth="50">
                                    <Items>
                                        <ext:TextField ID="txtSearchDock" runat="server"  Name="txtSearchDock"  Width="100">
                                            <Listeners>
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server">
                                    <Fields> 
                                        ...
                                        <ext:ModelField Name="QueueRegisterTypeDesc" /> 
                                        <ext:ModelField Name="IsActive" /> 
                                    </Fields>
                                </ext:Model>
                            </Model> 
                              <Sorters>
                                <ext:DataSorter Property="QueueRegisterTypeName" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store> 
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="30">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.QueueRegisterTypeID" Mode="Raw" /> 
                            ...
                            <ext:Column ID="colQueueDockName" Width="150" DataIndex="QueueRegisterTypeName" runat="server" Text="<%$ Resource : QUEUECONTACTNAME %>" Align="Center"  />
                            <ext:Column ID="colQueueDockDesc" Width="150" DataIndex="QueueRegisterTypeDesc" runat="server" Text="<%$ Resource : QUEUECONTACTDESC %>" Align="Left" />
