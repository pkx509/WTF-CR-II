<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllWarehouseName.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllWarehouseName" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" OnReadData="Store_Refresh"
                            ...
                            <Sorters>
                                <ext:DataSorter Property="WarehouseCode" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    <Features>
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.WarehouseID" Mode="Raw" />
                            ...
                            <ext:Column ID="Column1" runat="server" DataIndex="WarehouseCode" Text='<%$ Resource : WAREHOUSE_CODE %>' Align="Center" />
                            <ext:Column ID="ColumnTrailerCompany" runat="server" DataIndex="WarehouseName" Text='<%$ Resource : WAREHOUSE_NAME %>' Align="Left" Flex="1" />
                            <ext:Column ID="Column2" runat="server" DataIndex="WarehouseShortName" Text='<%$ Resource : WAREHOUSE_SHORT_NAME %>' Align="Center" Flex="1" />
                            <ext:Column ID="ColumnDriverCode" runat="server" DataIndex="SiteName" Text='<%$ Resource : SITE_NAME %>' Align="Center" Flex="1" />
                            <ext:Column ID="ColumnDriverFName" runat="server" DataIndex="WarehouseTypeName" Text='<%$ Resource : WAREHOUSE_TYPE_NAME %>' Align="Left" Flex="1" />
                            <ext:Column ID="ColumnDriverLName" runat="server" DataIndex="Description" Text='<%$ Resource : DESCRIPTION %>' Align="Left" Flex="1" />
