<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCreateGroup.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmCreateGroup" %>
                    ...
                    <Items>
                        <ext:Container runat="server" Layout="AnchorLayout" Flex="1" DefaultAnchor="100%">
                            ...
                            <Items>
                                ...
                                <ext:TextField runat="server" ID="txtName" FieldLabel='<%$ Resource : NAME %>' TabIndex="3" LabelWidth="140" MaxLength="50" EnforceMaxLength="true" AllowBlank="false" AllowOnlyWhitespace="false" AutoFocus="true" />
