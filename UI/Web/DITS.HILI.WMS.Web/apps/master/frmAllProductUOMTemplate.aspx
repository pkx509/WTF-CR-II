<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllProductUOMTemplate.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllProductUOMTemplate" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" 
                            ...
                            <Sorters>
                                <ext:DataSorter Property="Product_UOM_Template_ID" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            ...
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.Product_UOM_Template_ID" Mode="Raw" />
                            ...
                            <ext:Column ID="colUnitName" runat="server" DataIndex="Product_UOM_Template_Name" Text="<%$ Resource : PRODUCTUOMTEMPLATE_NAME %>" Align="Center" Flex="1" />
