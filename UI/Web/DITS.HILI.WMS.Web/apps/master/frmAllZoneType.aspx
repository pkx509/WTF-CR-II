<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllZoneType.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllZoneType" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20"
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="Code">
                                    <Fields>
                                        <ext:ModelField Name="ZoneTypeID" />
                                        <ext:ModelField Name="KeyType" />
                                        <ext:ModelField Name="Name" />
                                        <ext:ModelField Name="Description" />
                                        <%--<ext:ModelField Name="Site_Code" />
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.ZoneTypeID" Mode="Raw" />
                            ...
                            <%--<ext:Column TagHiddenName="sys_zonetype" ID="colZoneType_Code" runat="server" DataIndex="Code" Text='<%$ Resource : ZONE_TYPE_CODE %>' Align="Center" Flex="1" />--%>
                            <ext:Column TagHiddenName="sys_zonetype" ID="colZoneType_Name" runat="server" DataIndex="Name" Text='<%$ Resource : ZONE_TYPE_NAME %>' Align="Left" Flex="1" />
                            <%--<ext:Column TagHiddenName="sys_sitename" ID="colSite_Name" runat="server" DataIndex="Site_Name" Text='<%$ Resource : SITE_NAME %>' Align="Left" Flex="1" />--%>
                            <ext:Column TagHiddenName="sys_zonetype" ID="colZoneType_Description" runat="server" DataIndex="Description" Text='<%$ Resource : DESCRIPTION %>' Align="Left" Flex="1" />
                            <ext:Column ID="Column3" runat="server" DataIndex="KeyType" Text='<%$ Resource : PLACEMENT_TYPE %>' Align="Left" Flex="1" />
                            <ext:CheckColumn TagHiddenName="sys_zonetype" ID="colIsActive" runat="server" DataIndex="IsActive" Text="<%$ Resource : ACTIVE %>" Align="Center" Width="60" />
                        </Columns>
                    </ColumnModel>
                    <BottomBar>
                    ...
                    <%-- <DirectEvents>
                        <CellDblClick OnEvent="gvdDataListCenter_CellDblClick">
                            <ExtraParams>
                                <ext:Parameter Name="oDataKeyId" Value="record.data.ZoneType_Code" Mode="Raw" />
                            </ExtraParams>
                        </CellDblClick>
                    </DirectEvents>--%>
                    <SelectionModel>
