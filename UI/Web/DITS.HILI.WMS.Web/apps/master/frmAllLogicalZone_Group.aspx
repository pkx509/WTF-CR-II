<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllLogicalZone_Group.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllLogicalZone_Group" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" OnReadData="Store_Refresh"
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="LogicalZoneGroupId">
                                    <Fields>
                            ...
                            <Sorters>
                                <ext:DataSorter Property="LogicalZoneGroupId" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.LogicalZoneGroupId" Mode="Raw" />
                            ...
                            <ext:Column ID="colLogicalZoneGroupName" runat="server" DataIndex="LogicalZoneGroupName" Text="<%$ Resource : GROUP_NAME %>" Align="Left" Flex="1" Width="200" />
                             <ext:Column ID="colLogicalZoneGroupLevel3Name" runat="server" DataIndex="LogicalZoneGroupLevel3Name" Text="<%$ Resource : LOGICALZONE_GROUP_LEVEL3 %>" Align="Left" Flex="1" Width="200" />
                            <ext:CheckColumn ID="colIsActive" runat="server" DataIndex="IsActive" Text="<%$ Resource : ACTIVE %>" Align="Center" Width="60" Hidden="true" />
                        </Columns>
                    </ColumnModel>
                    <BottomBar>
