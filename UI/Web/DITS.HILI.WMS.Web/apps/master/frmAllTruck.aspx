<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllTruck.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllTruck" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" OnReadData="Store_Refresh"
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="DriverId">
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="EsitmateTime" />
                                        <ext:ModelField Name="EquipmentFlag" />
                            ...
                            <Sorters>
                                <ext:DataSorter Property="TypeName" Direction="DESC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.TruckTypeID" Mode="Raw" />
                            ...
                            <%--<ext:Column ID="Column3" runat="server" DataIndex="TruckType_ID" Text="Truck type code" Align="Left" Width="200" TagHiddenName="" />--%>
                            <ext:Column ID="Column1" runat="server" DataIndex="TypeName" Text='<%$ Resource : TRUCK_TYPE_NAME %>' Align="Left" Width="200" TagHiddenName="" />
                            <ext:Column ID="Column2" runat="server" DataIndex="Description" Text='<%$ Resource : TRUCK_TYPE_DESC %>' Align="Left" Width="200" TagHiddenName="" />
                            <ext:Column ID="Column3" runat="server" DataIndex="EsitmateTime" Text='<%$ Resource : TRUCK_TYPE_ESITMATETIME %>' Align="Left" Width="200" TagHiddenName="" />
                            <ext:CheckColumn ID="CheckColumn1" DataIndex="EquipmentFlag" Text="<%$ Resource : EQUIPMENTFLAG %>" runat="server" Align="Center" Width="100" />
                            <ext:CheckColumn ID="colIsDefault" DataIndex="IsDefault" Text="<%$ Resource : ACTIVE %>" runat="server" Align="Center" Width="100" />
                        </Columns>
                    </ColumnModel>
                    <BottomBar>
