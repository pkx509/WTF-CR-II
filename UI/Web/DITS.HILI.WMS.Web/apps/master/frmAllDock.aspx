<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllDock.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllDock" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" 
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="DockName">
                                    <Fields>
                            ...
                            <Sorters>
                                <ext:DataSorter Property="DockName" Direction="DESC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.DockConfigID" Mode="Raw" />
                            ...
                            <%--<ext:Column ID="Column3" runat="server" DataIndex="DockType_ID" Text="Dock code" Align="Left" Width="200" TagHiddenName="d" />--%>
                            <ext:Column ID="Column1" runat="server" DataIndex="DockName" Text='<%$ Resource : DOCK_NAME %>' Align="Left" Width="200" TagHiddenName="d" />
                            <ext:Column ID="Column7" runat="server" DataIndex="WarehouseName" Text='<%$ Resource : WAREHOUSE_NAME %>' Align="Left" Width="200" TagHiddenName="w" />
                            <ext:Column ID="Column2" runat="server" DataIndex="TypeName" Text='<%$ Resource : TRUCK_TYPE_NAME %>' Align="Left" Width="200" TagHiddenName="t" />
