<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllStandard_Unit.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllStandard_Unit" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" OnReadData="Store_Refresh"
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="UnitID">
                                    <Fields>
                            ...
                            <Sorters>
                                <ext:DataSorter Property="UnitID" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            ...
                            <ext:Column ID="colUnitName" runat="server" DataIndex="Name" Text="<%$ Resource : UNIT_NAME %>" Align="Left" Flex="1" />
                            <ext:Column ID="colUnitDesc" runat="server" DataIndex="ShortName" Text="<%$ Resource : UNIT_SHORT_NAME %>" Align="Center" Flex="1" />
                            <ext:CheckColumn ID="colIsActive" runat="server" DataIndex="IsActive" Text="<%$ Resource : ACTIVE %>" Align="Center" Width="60" />
                        </Columns>
                    </ColumnModel>
                    <BottomBar>
