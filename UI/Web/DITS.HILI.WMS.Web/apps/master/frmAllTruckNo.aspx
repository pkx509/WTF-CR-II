<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAllTruckNo.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.master.frmAllTruckNo" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Region="Center" Frame="true">
                        ...
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" OnReadData="Store_Refresh"
                            ...
                            <Model>
                                <ext:Model ID="Model" runat="server" IDProperty="DriverId">
                                    <Fields>
                                        <ext:ModelField Name="TruckID" />
                                        <ext:ModelField Name="TruckNo" />
                            ...
                            <Sorters>
                                <ext:DataSorter Property="TruckNo" Direction="DESC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            <ext:CommandColumn runat="server" ID="colDel" Sortable="false" Align="Center" Width="20">
                                ...
                                <DirectEvents>
                                    <Command OnEvent="CommandClick">
                                        <ExtraParams>
                                            <ext:Parameter Name="oDataKeyId" Value="record.data.TruckID" Mode="Raw" />
                            ...
                            <ext:Column ID="Column3" runat="server" DataIndex="TruckNo" Text="<%$ Resource : TRUCK_NO %>" Align="Left" Width="100" TagHiddenName="" />
