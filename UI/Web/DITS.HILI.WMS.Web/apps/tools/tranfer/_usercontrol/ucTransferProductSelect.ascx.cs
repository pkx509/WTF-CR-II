...
{
    public partial class ucTransferProductSelect : System.Web.UI.UserControl
    {
        ...
        public object ProductSelectBindData(string action, Dictionary<string, object> extraParams)
        {
            ...
            Core.Domain.ApiResponseMessage apiResp = InventoryToolsClient.GetProductStock(txtSearch.Text,
                                                         hidOrderNo.Text,
                                                         "NORMAL",
                                                         hidRefCode.Text, prms.Page,
