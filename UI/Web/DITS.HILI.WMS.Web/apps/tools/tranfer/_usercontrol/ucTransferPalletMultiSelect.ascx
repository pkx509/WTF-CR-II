<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTransferPalletMultiSelect.ascx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.tranfer._usercontrol.ucTransferPalletMultiSelect" %>
