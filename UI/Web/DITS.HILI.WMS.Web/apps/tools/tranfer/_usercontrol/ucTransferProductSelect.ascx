<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucTransferProductSelect.ascx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.qa.usercontrol.ucTransferProductSelect" %>
