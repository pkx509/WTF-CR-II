<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReLocationList.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.relocation.frmReLocationList" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server"> 
    <title>Re-Location List</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Viewport runat="server" Layout="BorderLayout">
            <Items>
                <ext:GridPanel ID="grdDataList" runat="server" Region="Center" Frame="true" Title="Re-Location List">
                    <TopBar>
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20" RemoteSort="false" GroupField="Receive_Date_Estimate">
                            <Proxy>
                            ...
                            <Model>
                             <ext:Model ID="Model" runat="server" >
                                    <Fields>
                                        ...
                                        <ext:ModelField Name="ReLocationNo" />
                                        <ext:ModelField Name="DocumentRef" />
                                         <ext:ModelField Name="WareHouse" />
                                        <ext:ModelField Name="ReLocationDate" Type="Date" />
                    ...
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        ...
                        <Columns>
                            ...
                            <ext:Column ID="colReLocationNo" runat="server" DataIndex="ReLocationNo" Text="ReLocation No."
                                Align="Center" Width="150" />
                            <ext:Column ID="colWareHouse" runat="server" DataIndex="WareHouse" Text="WareHouse"
                                Align="left" Flex="1" />
                                                        <ext:Column ID="Column1" runat="server" DataIndex="DocumentRef" Text="Document Ref"
                                Align="left" Flex="1" />
                            <ext:DateColumn ID="colPutawyDate" runat="server" DataIndex="PutawyDate"
                                Text="Putawy Date" Align="Center" Width="120" Format="dd/MM/yyyy"/>
                       
                            <ext:DateColumn ID="colStartDate" runat="server" DataIndex="StartDate" Text="Start Date"
                                Align="Center" Width="120" Format="dd/MM/yyyy">
                            </ext:DateColumn>
                            <ext:DateColumn ID="colCompleteDate" runat="server" DataIndex="CompleteDate" Text="Complete Date"
                                Align="Center" Width="120" Format="dd/MM/yyyy">
                            </ext:DateColumn>
