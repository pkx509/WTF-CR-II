<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProductReLocationSelect.ascx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.relocation._usercontrol.ucProductReLocationSelect" %>
...
<script>
    ...
    var KeyPressHandler = function (e) {
        ...
        if (App.ucProductReLocationSelect_StoreProductSelect.totalCount > 0) {
            var data = App.ucProductReLocationSelect_StoreProductSelect.data.items[0].data;
...
<ext:Window runat="server" Title="Product Select"
    ...
    <Items>
        <ext:GridPanel ID="grdProductSelect" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
            <Listeners>
                <AfterRender Handler="loadFilter(App.ucProductReLocationSelect_grdProductSelect.filterHeader,'');" />
            </Listeners>
            ...
            <KeyMap runat="server">
                <Binding>
                    <ext:KeyBinding Handler="if (App.ucProductReLocationSelect_StoreProductSelect.totalCount > 0) {var data = App.ucProductReLocationSelect_StoreProductSelect.data.items[0].data;App.direct.ucProductCode_Select(data); }"
