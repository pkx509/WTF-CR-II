...
namespace DITS.HILI.WMS.Web.apps.tools.relocation._usercontrol
{
    public partial class ucProductReLocationSelect : System.Web.UI.UserControl
    {
        ...
        public void FilterHeader(string _product_code)
        {
            ...
            X.AddScript("loadFilter(App.ucProductReLocationSelect_grdProductSelect.filterHeader,'" + _product_code + "');");
        }
