<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmInspectionDispatchlist.aspx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.frmInspectionDispatchlist" %>
                ...
                <ext:GridPanel ID="grdDataList" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
                                ...
                                <ext:FieldContainer runat="server"
                                    ...
                                    <Items>
                                        ...
                                        <ext:DateField runat="server"
                                            ID="dtStartDate"
                                            FieldLabel='<%$ Resource : INSPECTION_START %>'
                                            MaxLength="10"
                                            AllowBlank="false"
                                        ...
                                        <ext:DateField runat="server"
                                            ID="dtEndDate"
                                            AllowBlank="false"
                                            FieldLabel='<%$ Resource : INSPECTION_END %>'
                                            MaxLength="10"
                                            EnforceMaxLength="true"
                                            Format="dd/MM/yyyy"
                                            Flex="1"
                    ...
                    <Store>
                        <ext:Store ID="StoreOfDataList" runat="server" PageSize="20">
                            ...
                            <Sorters>
                                <ext:DataSorter Property="ReclassifiedID" Direction="ASC" />
                            </Sorters>
                        </ext:Store>
                    </Store>
                    <ColumnModel ID="ColumnModelDriver" runat="server">
                        <Columns>
                            ...
                            <ext:DateColumn ID="Column1" runat="server" DataIndex="MFGDate" Text='<%$ Resource : MFGDATE %>' Vtype="daterange" Align="Left" Format="dd/MM/yyyy" Width="100" />
                  
                            <ext:DateColumn ID="DateColumn1" runat="server" DataIndex="DateCreated" Text='<%$ Resource : INSPECTION_DATE %>' Vtype="daterange" Align="Left" Format="dd/MM/yyyy" Width="100" />
