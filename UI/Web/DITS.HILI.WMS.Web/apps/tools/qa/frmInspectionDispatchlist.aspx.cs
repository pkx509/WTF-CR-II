...
{
    public partial class frmInspectionDispatchlist : BaseUIPage
    {
        ...
        private void GetAddEditForm(string id)
        {
            ...
            WindowShow.ShowNewPage(this, strTitle, "InspectionDispatch", "frmInspectionDispatch.aspx?oDataKeyId=" + id, Icon.Add);
        }
        ...
        public object BindData(string action, Dictionary<string, object> extraParams)
        {
            try
            {
                ...
                Core.Domain.ApiResponseMessage apiResp = InventoryToolsClient.GetInspectionDispatch(dtStartDate.SelectedDate, dtEndDate.SelectedDate, cmbStatus.SelectedItem.Value, txtSearch.Text, prms.Page, int.Parse(cmbPageList.SelectedItem.Value)).Result;
