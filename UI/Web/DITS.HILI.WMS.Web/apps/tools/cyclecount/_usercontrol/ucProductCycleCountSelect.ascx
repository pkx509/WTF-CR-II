<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucProductCycleCountSelect.ascx.cs" Inherits="DITS.HILI.WMS.Web.apps.tools.cyclecount._usercontrol.ucProductCycleCountSelect" %>
...
<script>
    ...
    var KeyPressHandler = function (e) {
        ...
        if (App.ucProductCycleCountSelect_StoreProductSelect.totalCount > 0) {
            var data = App.ucProductCycleCountSelect_StoreProductSelect.data.items[0].data;
...
<ext:Window runat="server" Title="Product Select"
    ...
    <Items>
        <ext:GridPanel ID="grdProductSelect" runat="server" Margins="0 0 0 0" Region="Center" Frame="true">
            <Listeners>
                <AfterRender Handler="loadFilter(App.ucProductCycleCountSelect_grdProductSelect.filterHeader,'');" />
            </Listeners>
            ...
            <KeyMap runat="server">
                <Binding>
                    <ext:KeyBinding Handler="if (App.ucProductCycleCountSelect_StoreProductSelect.totalCount > 0) {var data = App.ucProductCycleCountSelect_StoreProductSelect.data.items[0].data;App.direct.ucProductCode_Select(data); }"
