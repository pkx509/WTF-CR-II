...
{
    public partial class ucProductAdjustSelect : System.Web.UI.UserControl
    {
        ...
        public void FilterHeader(string _product_code)
        {
            ...
            X.AddScript("loadFilter(App.ucProductAdjustSelect_grdProductSelect.filterHeader,'" + _product_code + "');");
        }
