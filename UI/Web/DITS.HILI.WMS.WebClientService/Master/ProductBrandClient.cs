...
{
    public class ProductBrandClient
    {
        //static Ref<int> _total = new Ref<int>();
        //public static async Task<ProductBrand> GetByID(Guid id)
        //{
        //    return await HttpService.Get<ProductBrand>("productbrand/getbyid?id=" + id, _total, null, null, Common.User.UserID, Common.Language, Common.AccessToken);
        //}

        //public static async Task<List<ProductBrand>> Get(string keyword, Ref<int> total, int? pageIndex, int? pageSize)
        //{
        //    return await HttpService.Get<List<ProductBrand>>("productbrand/get?keyword=" + keyword, total, pageIndex, pageSize,   Common.User.UserID, Common.Language, Common.AccessToken);
        //}
