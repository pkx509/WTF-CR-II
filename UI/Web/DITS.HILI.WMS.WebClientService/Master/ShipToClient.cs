...
namespace DITS.HILI.WMS.ClientService.Master
{
    public class ShipToClient
    {
        ...
        public static async Task<ApiResponseMessage> Get(string keyword, int? pageIndex, int? pageSize)
        {
            ...
            ApiResponseMessage resp = await HttpService.GetAsync("shipto/get", parameters, Common.User.UserID, Common.Language, Common.AccessToken).ConfigureAwait(false);
